...
The development history of this project in a film:

<video src="https://raw.githubusercontent.com/itsdarklikehell/dm-assist/v1.5-dev/gource-720p-v2.mp4" controls width="100%"></video>

*The video is automatically generated by the [Gource workflow](.github/workflows/gource.yml) on each push — rendered via [nbprojekt/gource-action@v1.3.0](https://github.com/marketplace/actions/gource-action) at 720p (GitHub 100MB limit compliance).*

Generate locally (requires Gource + ffmpeg):
